...
- Les boutons atlas utilitaires (`Home`, `Menu`, `Profil`) et `Fermer` appliquent un effet d’écrasement de **1 px** au clic pour exploiter la double ligne basse prévue dans les sprites.
