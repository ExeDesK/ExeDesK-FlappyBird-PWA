...
> **État du projet : bêta — v0.2.7.2b-dev2**
...
- Verified Runs en développement : PLAY authentifié par ticket/seed serveur, avertissement hors ligne, capture déterministe et file locale avant soumission.
