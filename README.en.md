...
> **Project status: beta — v0.2.7.7b-hotfix1**
...
- On wide screens, `Menu`, `Home` and `Profile` are anchored to the right edge of the centered game viewport, so black side bars are excluded from their positioning area.
